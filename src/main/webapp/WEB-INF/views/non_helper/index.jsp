...
<div class=”mainFrame”  style="position: relative; width: 480px; height: 1030px; border:1px solid black; display: inline-block;">
    ...
    <div style="display: flex; justify-content: center;">
            <button onclick="location.href='insertHelper'" class="btn2" style="font-weight: bold; font-size: 16px; color: rgba(0, 0, 0, 0.3); margin: 40px 20px; background: white; border: none;">회원가입</button>
            <button onclick="location.href='findId'" class="btn2" style="font-weight: bold; font-size: 16px; color: rgba(0, 0, 0, 0.3); margin: 40px 20px; background: white; border: none;">아이디 찾기</button>
            <button onclick="location.href='findPassword'" class="btn2" style="font-weight: bold; font-size: 16px; color: rgba(0, 0, 0, 0.3); margin: 40px 20px; background: white; border: none;">비밀번호 찾기</button>
    </div>
